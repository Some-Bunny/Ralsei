...
namespace Ralsei
{
    ...
    public class CustomProjectileSlashingBehaviour : MonoBehaviour
    {
        ...
        private void DoSlash(float angle)
        {
            ...
            slashData.Owner = projectile.Owner ?? owner;
            ...
            CustomSlashDoer.DoSwordSlash(m_projectile.specRigidbody.UnitCenter, m_projectile.Direction.ToAngle() + angle, projectile.Owner ?? owner, slashData);
        }
