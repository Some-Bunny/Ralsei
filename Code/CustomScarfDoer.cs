...
namespace Ralsei
{
    public class CustomScarfDoer : MonoBehaviour
    {
        public CustomScarfDoer()
        {
            StartWidth = 0.0625f;
            EndWidth = 0.125f;
            AnimationSpeed = 1f;
        ...
        public Vector3 AdditionalOffset = Vector2.zero;
        ...
        public void Initialize(GameActor target)
        {
            ...
            transform.position = AttachTarget.transform.position + m_currentOffset.ToVector3ZisY(-3f) + AdditionalOffset;
        }
        ...
        private void LateUpdate()
        {
            ...
            if (AttachTarget != null)
            {
                ...
                m_currentOffset =  (Quaternion.Euler(0f, 0f, m_lastVelAngle) * Vector2.left * d).XY().ToVector3ZisY();
                ...
                Vector3 vector2 = vector + m_currentOffset.ToVector3ZisY(-3f) + AdditionalOffset;
        ...
        private void BuildMeshAlongCurve(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3, float zOffset)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                vector3 += new Vector2(AdditionalOffset.x, AdditionalOffset.y);
