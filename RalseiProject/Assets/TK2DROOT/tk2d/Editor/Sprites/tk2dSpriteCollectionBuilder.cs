    ...
    static void UpdateVertexCache(tk2dSpriteCollection gen, float scale, tk2dEditor.Atlas.Data[] packers, tk2dSpriteCollectionData coll, List<SpriteLut> spriteLuts)
    {
        for (int i = 0; i < sourceTextures.Length; ++i)
        {
            ...
            if (mesh)
            {
				...
				coll.spriteDefinitions[i].position0 = coll.spriteDefinitions[i].positions[0];
				coll.spriteDefinitions[i].position1 = coll.spriteDefinitions[i].positions[1];
				coll.spriteDefinitions[i].position2 = coll.spriteDefinitions[i].positions[2];
				coll.spriteDefinitions[i].position3 = coll.spriteDefinitions[i].positions[3];
			...
			coll.spriteDefinitions[i].boundsDataCenter = coll.spriteDefinitions[i].boundsData[0];
			coll.spriteDefinitions[i].boundsDataExtents = coll.spriteDefinitions[i].boundsData[1];

			coll.spriteDefinitions[i].untrimmedBoundsDataCenter = coll.spriteDefinitions[i].untrimmedBoundsData[0];
			coll.spriteDefinitions[i].untrimmedBoundsDataExtents = coll.spriteDefinitions[i].untrimmedBoundsData[1];
